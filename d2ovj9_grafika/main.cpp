...
void myDisplay(void)
{
	...
	{
		haromszog();
		haromszog_eltolt(transX, transY);
	}
	else if (choice == 2)
	{
		haromszog();
		haromszog_nagyitott(scaleX, scaleY);
	}
	else if (choice == 3)
	{
		haromszog();
...
int main(int argc, char** argv)
{
	...
	if (choice == 1)
	{
		cout << "Ajda meg az eltolas X es Y merteket: "; cin >> transX >> transY;
	}
	else if (choice == 2)
	{
		cout << "Adja meg a nagyitas X es Y merteket: "; cin >> scaleX >> scaleY;
	}
	else if (choice == 3)
	{
