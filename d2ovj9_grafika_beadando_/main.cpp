...
void mx_szorzas(double transzformacio_mx[3][3], double koordinata_mx[3][3], double eredmeny[3][3])
{
    for(int i=0; i<3; i++)
    {
        for(int j=0; j<3; j++)
...
//Az eredeti koordinatak alapjan   *
//**********************************
...
void haromszog_eltolt(int x, int y)
{
    ...
    mx_szorzas(eltolo_mx, haromszog_mx, eltolt_mx);
...
void haromszog_nagyitott(double x, double y)
{
    ...
    mx_szorzas(nagyito_mx, haromszog_mx, nagyitott_mx);
...
//***********************************
//A csucsok eredeti koordinatainak  *
//matrixat megszorozzuk az          *
//elforgatas matrixaval, majd       *
//megjelenitjuk.                    *
//***********************************
...
void haromszog_elforgatott(double szog_radian)
{
    ...
    mx_szorzas(elforgato_mx, haromszog_mx, elforgatott_mx);
...
void haromszog_tukrozott(char tukrozo_tengely)
{
	...
	if (tukrozo_tengely == 'x' || tukrozo_tengely == 'X')
	{
        ...
        mx_szorzas(tukrozes_x_mx, haromszog_mx, tukrozott_mx);
	...
	else if (tukrozo_tengely == 'y' || tukrozo_tengely == 'Y')
	{
        ...
        mx_szorzas(tukrozes_y_mx, haromszog_mx, tukrozott_mx);
        glVertex2d(tukrozott_mx[0][0], tukrozott_mx[1][0]);
        glVertex2d(tukrozott_mx[0][1], tukrozott_mx[1][1]);
        glVertex2d(tukrozott_mx[0][2], tukrozott_mx[1][2]);
